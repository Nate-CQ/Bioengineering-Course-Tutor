...
COURSES = {
    "signals_systems": {
        ...
        "example_contexts": [
            ...
            "cochlear implant signal coding",
            "EEG and neural signal recording",
            "pulse oximetry and photoplethysmography",
            "ultrasound and biomedical imaging",
            "EMG and muscle activity signals",
            "hearing aid audio processing",
            "wearable fitness and heart-rate sensors",
        ],
    },
    "physiology": {
        ...
        "example_contexts": [
            ...
            "a patient with COPD or asthma",
            "an athlete during intense exercise",
            "a patient with a spinal cord injury",
            "a patient with hypothyroidism or hyperthyroidism",
            "a patient in shock or severe dehydration",
            "a healthy individual at high altitude",
    ...
    "biomaterials": {
        ...
        "quantitative": True,
        "example_contexts": [
            "cardiovascular stents and heart valves",
            "dental implants and restorations",
            "contact lenses and other ophthalmic devices",
            "wound dressings and skin substitutes",
            "drug delivery systems and controlled release coatings",
            "sutures and tissue adhesives",
            "orthopedic implants (hip, knee, or spinal)",
            "catheters and vascular grafts",
            "tissue engineering scaffolds",
            "bone cements and dental fillings",
            "cochlear implants and other neural interfaces",
        ],
    },
    "biostatistics": {
        ...
        "example_contexts": [
            ...
            "a medical device performance study",
            "a genomics or lab-assay dataset",
            "a public health survey",
            "a diagnostic test accuracy study",
            "a wearable or sensor data study",
            "a nutrition or lifestyle intervention study",
            "a hospital readmission or outcomes dataset",
        ],
    },
}
